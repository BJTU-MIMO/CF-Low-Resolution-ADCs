function [gainOverNoisedB,R,pilotIndex,APpositions,UEpositions,distancesUE] = Z_generateSetup_threeslope(L,K,N,tau_p,nbrOfSetups,p)
%INPUT:
...
for n = 1:nbrOfSetups
    ...
    for m = 1:K
        ...
        SE_CF = functionComputeSE_CF_uplink_ngo(p,p*ones(K,1),L,K,tau_p,tau_p+1,pilotIndex(:,n),betaVal);
